    ...
    return (
        <header className="h-14 border-b flex items-center justify-between px-4 bg-background z-10 sticky top-0 shadow-sm">
            <div className="flex items-center gap-4">
                <Button aria-label="Open navigation menu" variant="ghost" size="icon" className="md:hidden" onClick={toggleSidebar}>
            ...
            <div className="flex items-center gap-4">
                <Button aria-label="View notifications" variant="ghost" size="icon" className="relative">
                    ...
                    <span aria-hidden="true" className="absolute top-1.5 right-1.5 h-2 w-2 rounded-full bg-primary" />
                ...
                <div className="h-8 w-8 rounded-full bg-primary/20 flex items-center justify-center font-semibold text-primary overflow-hidden">
                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=cerebro" alt="Cerebro user avatar" />
                </div>
            </div>
        </header>
    );
