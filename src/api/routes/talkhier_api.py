...
async def execute_refinement_round(
    ...
    try:
        ...
        await websocket_handler.broadcast_round_completed(session_id, round_response)
...
async def close_session(
    ...
    try:
        ...
        await websocket_handler.broadcast_session_completed(session_id, close_response)
