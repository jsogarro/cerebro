...
async def fact_check(text: str):
    """Check facts in text."""
    return {"facts": [], "verified": 0, "failed": 0}


@router.post("/citations/verify")
async def verify_citations(citations: List[str]):
    """Verify citations."""
