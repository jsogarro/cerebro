    ...
    def _create_plotly_network(
        ...
        node_trace = go.Scatter(
            ...
            marker={
                ...
                "color": [],
                "size": 10,
                "colorbar": {"thickness": 15, "len": 0.5, "x": 1.01},
...
def create_source_distribution_viz(
    ...
    return Visualization(
        ...
        data={"x": list(year_counts.keys()), "y": list(year_counts.values())},
        config={"x_label": "Publication Year", "y_label": "Number of Sources"},
        caption=None,
        width=None,
        height=None,
    )
...
def create_domain_coverage_viz(
    ...
    return Visualization(
        ...
        data={"labels": domains, "values": [1] * len(domains)},
        config={"donut": True},
        caption=None,
        width=None,
        height=None,
...
def create_confidence_radar_viz(
    ...
    return Visualization(
        ...
        data={"categories": categories, "values": confidence_scores},
        config={},
        caption=None,
        width=None,
        height=None,
